...
if __name__ == "__main__":
    train_data = pd.read_csv('dataset/subreddit.csv', encoding='ISO-8859-1')
    # preprocessing
    X = train_data['body'].apply(preprocess)
    ...
    print(f"Bernoulli Naive Bayes\n Accuracy: {accuracy_bnb}, F1 Score: {f1_bnb}")
    ...
    print(f"Decision Tree\n Accuracy: {accuracy_dt}, F1 Score: {f1_dt}")
    ...
    print(f"Multi layer perceptron\n Accuracy: {accuracy_mlp}, F1 Score: {f1_mlp}")
